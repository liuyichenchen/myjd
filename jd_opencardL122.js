...
[task_local]
#4.18-4.24 发现精彩世界
35 13 18-24 4 * jd_opencardL122.js, tag=4.18-4.24 发现精彩世界, enabled=true
  ...
  try {
	...
	if(opencard_toShop+"" == "true"){    
      ...
      for(let v of $.toShopList || []){
        ...
        console.log('如需浏览店铺请设置环境变量[opencard_toShop122]为"true"');
      }
	}
    $.runFalag = true
    $.log("浏览商品: " + $.visitSku)
